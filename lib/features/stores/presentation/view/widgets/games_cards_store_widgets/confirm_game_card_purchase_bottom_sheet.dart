...
class ConfirmGameCardPurchaseBottomSheet extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Column(
                      ...
                      children: [
                        Text(
                          names.confirmPurchase,
                          style: TextStyleManager.style24BoldWhite,
                        ),
                        Text(
                          names.confirmPurchaseDescription,
            ...
            Text(
              "45.00 ر.س",
              style: TextStyleManager.style16LightBlack,
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                SvgPicture.asset(IconManager.coin),
                Gap(4.w),
                Text(
                  "450",
                  style: TextStyleManager.style29BoldBlack,
                ),
              ],
            ),
            Padding(
